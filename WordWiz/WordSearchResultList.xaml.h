...
namespace winrt::WordWiz::implementation
{
	struct WordSearchResultList : WordSearchResultListT<WordSearchResultList>
	{
		...
		// 事件处理函数
		void ResultsListView_SelectionChanged(Windows::Foundation::IInspectable const& sender,
		                                      Microsoft::UI::Xaml::Controls::SelectionChangedEventArgs const& args);
		void SearchTextBox_TextChanged(Windows::Foundation::IInspectable const& sender,
		                               Microsoft::UI::Xaml::Controls::TextChangedEventArgs const& args);
		// 新增 KeyDown 事件处理函数 for Enter key
		void SearchTextBox_KeyDown(Windows::Foundation::IInspectable const& sender,
	...
	private:
		...
		void OnDebounceTimerTick(Windows::Foundation::IInspectable const& sender,
