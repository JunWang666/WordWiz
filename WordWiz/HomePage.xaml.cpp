...
namespace winrt::WordWiz::implementation
{
	...
	{
		winrt::Microsoft::UI::Xaml::Controls::Frame mainFrame =
			winrt::WordWiz::implementation::MainWindow::GetMainFrame();
		if (mainFrame)
		{
...
void winrt::WordWiz::implementation::HomePage::TextBox_DragEnter(winrt::Windows::Foundation::IInspectable const& sender,
                                                                 winrt::Microsoft::UI::Xaml::DragEventArgs const& e)
{
}

void winrt::WordWiz::implementation::HomePage::TextBox_KeyDown(winrt::Windows::Foundation::IInspectable const& sender,
