...
namespace WordWizServices
{
	...
	NavigationService::FrameContext* NavigationService::GetFrameContext(
		winrt::Microsoft::UI::Xaml::Controls::Frame const& targetFrame, bool createIfNotFound)
	{
	...
	bool NavigationService::GoBack(winrt::Microsoft::UI::Xaml::Controls::Frame const& targetFrame,
	                               winrt::Microsoft::UI::Xaml::Media::Animation::NavigationTransitionInfo const&
	                               infoOverride)
	{
	...
	winrt::event_token NavigationService::AddNavigationListener(
		std::function<void(NavigationEventArgs const&)> const& listener)
	{
		...
		winrt::Microsoft::UI::Xaml::Navigation::NavigationFailedEventArgs const& e)
	{
		...
		if (failedFrame) ss << L" (Frame hash: " << std::hash<winrt::Windows::Foundation::IInspectable>{}(failedFrame)
			<< L")"; // 简单标识Frame
