...
namespace winrt::WordWiz::implementation
{
	...
	void MainWindow::NavigationView_SelectionChanged(const winrt::Microsoft::UI::Xaml::Controls::NavigationView sender,
	                                                 const
		...
		else
		{
			...
			if (selectedItem)
			{
				...
				if (sender.PaneDisplayMode() ==
					winrt::Microsoft::UI::Xaml::Controls::NavigationViewPaneDisplayMode::Top)
				{
	...
	void MainWindow::NavigationView_ItemInvoked(winrt::Microsoft::UI::Xaml::Controls::NavigationView const& sender,
	                                            winrt::Microsoft::UI::Xaml::Controls::NavigationViewItemInvokedEventArgs
	                                            const& args)
	{
		...
		else
		{
			...
			auto invokedItem = args.InvokedItemContainer().try_as<
	...
	void MainWindow::CustomPaneToggleButton_Click(IInspectable const&,
...
void winrt::WordWiz::implementation::MainWindow::BackButton_RightTapped(
	winrt::Windows::Foundation::IInspectable const& sender,
