...
namespace winrt::WordWiz::implementation
{
	...
	public:
		...
		void NavigationView_SelectionChanged(const winrt::Microsoft::UI::Xaml::Controls::NavigationView,
		                                     const
		...
		void OnWindowLoaded(winrt::Windows::Foundation::IInspectable const& sender,
