...
namespace winrt::WordWiz::implementation
{
    struct WordDetails : WordDetailsT<WordDetails>
    {
        ...
        // SelectorBar 的事件处理
        void DictionarySelectorBar_SelectionChanged(SelectorBar const& sender, SelectorBarSelectionChangedEventArgs const& args);
        ...
        static void OnSelectedDictionaryHtmlChanged(DependencyObject const& d, DependencyPropertyChangedEventArgs const& e);
