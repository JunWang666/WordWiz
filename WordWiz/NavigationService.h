...
namespace WordWizServices
{
	...
	public:
		...
		static bool GoBack(winrt::Microsoft::UI::Xaml::Controls::Frame const& targetFrame,
		...
		AddNavigationListener(std::function<void(NavigationEventArgs const&)> const& listener);
		static void RemoveNavigationListener(winrt::event_token const& token);

	private:
		static FrameContext* GetFrameContext(winrt::Microsoft::UI::Xaml::Controls::Frame const& targetFrame,
