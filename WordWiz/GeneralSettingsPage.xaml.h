...
namespace winrt::WordWiz::implementation
{
	struct GeneralSettingsPage : GeneralSettingsPageT<GeneralSettingsPage>
	{
		...
		void ThemeRadio_Checked(winrt::Windows::Foundation::IInspectable const& sender,
		                        winrt::Microsoft::UI::Xaml::RoutedEventArgs const& e);
		void OpenFolderButton_Click(winrt::Windows::Foundation::IInspectable const& sender,
		                            winrt::Microsoft::UI::Xaml::RoutedEventArgs const& e);
