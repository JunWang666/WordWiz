...
namespace winrt::WordWiz::implementation
{
	struct DictionarySettingsPage : DictionarySettingsPageT<DictionarySettingsPage>
	{
		...
		// 词典导入事件处理程序
		void ImportSingleFileButton_Click(winrt::Windows::Foundation::IInspectable const& sender,
		                                  winrt::Microsoft::UI::Xaml::RoutedEventArgs const& e);
		void ImportMultipleFilesButton_Click(winrt::Windows::Foundation::IInspectable const& sender,
		                                     winrt::Microsoft::UI::Xaml::RoutedEventArgs const& e);
	...
	private:
		...
		void ShowMultipleFilesFlyout(const winrt::hstring& message, const winrt::hstring& detail = L"",
		                             bool showProgress = true, bool isSuccess = false);
